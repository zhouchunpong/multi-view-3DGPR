...
parser.add_argument('--model_names', type=str, nargs='+', default=['ResNet50'])
parser.add_argument('--type', type=str, default='SingleTopView')
parser.add_argument('--version', type=str, default='CBAM_base')
...
for times in range(10):
    ...
    # 加载预训练模型
    model_top = resnet50(num_class=args.num_classes)
